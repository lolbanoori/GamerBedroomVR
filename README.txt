=== VR Bedroom Project: Gamer Room ===

Author: Syed Zohair Ali Shah Banoori  
Course: 3D Models for Virtual Reality  
...
Note that this project can be viewed with or without a headset (read below).
...
Important Notes:
- This project is designed for viewing in VR scale. Avoid moving outside the room boundaries.
- Due to collider issues, falling off the room can result in indefinite falling. Movement is not constrained.
